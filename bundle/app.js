...
(() => {
  ...
  function _(l4, u5, t3) {
    ...
    if (
      (arguments.length > 2 && (f5.children = arguments.length > 3 ? n.call(arguments, 2) : t3), "function" == typeof l4 && null != l4.defaultProps)
    )
      for (r3 in l4.defaultProps) void 0 === f5[r3] && (f5[r3] = l4.defaultProps[r3]);
  ...
  function P() {
    ...
    for (i.sort(f); (n2 = i.shift()); )
      n2.__d &&
        ...
        (s4 = []),
        t3.__P &&
          (((o4 = d({}, r3)).__v = r3.__v + 1),
          l.vnode && l.vnode(o4),
          O(t3.__P, o4, r3, t3.__n, t3.__P.namespaceURI, 32 & r3.__u ? [e3] : null, c4, null == e3 ? x(r3) : e3, !!(32 & r3.__u), s4),
          (o4.__v = r3.__v),
          (o4.__.__k[o4.__i] = o4),
          j(c4, o4, s4),
          o4.__e != e3 && C(o4)),
        i.length > u5 && i.sort(f));
    P.__r = 0;
  }
  function S(n2, l4, u5, t3, i6, o4, r3, f5, e3, c4, s4) {
    ...
    for (u5.__d = e3, $(u5, l4, _2), e3 = u5.__d, a4 = 0; a4 < g2; a4++)
      null != (y4 = u5.__k[a4]) &&
        ...
        (y4.__i = a4),
        O(n2, y4, v4, i6, o4, r3, f5, e3, c4, s4),
        (d4 = y4.__e),
        y4.ref && v4.ref != y4.ref && (v4.ref && N(v4.ref, null, y4), s4.push(y4.ref, y4.__c || d4, y4)),
  ...
  function $(n2, l4, u5) {
    ...
    for (n2.__k = [], t3 = 0; t3 < e3; t3++)
      (r3 = t3 + a4),
        null !=
        (i6 = n2.__k[t3] =
          null == (i6 = l4[t3]) || "boolean" == typeof i6 || "function" == typeof i6
            ? null
            : "string" == typeof i6 || "number" == typeof i6 || "bigint" == typeof i6 || i6.constructor == String
              ? g(null, i6, null, null, null)
              : y(i6)
                ? g(k, { children: i6 }, null, null, null)
                : void 0 === i6.constructor && i6.__b > 0
                  ? g(i6.type, i6.props, i6.key, i6.ref ? i6.ref : null, i6.__v)
                  : i6)
          ? ((i6.__ = n2),
            (i6.__b = n2.__b + 1),
            (f5 = L(i6, u5, r3, s4)),
            (i6.__i = f5),
            (o4 = null),
            -1 !== f5 && (s4--, (o4 = u5[f5]) && (o4.__u |= 131072)),
            null == o4 || null === o4.__v
              ? (-1 == f5 && a4--, "function" != typeof i6.type && (i6.__u |= 65536))
              : f5 !== r3 &&
                (f5 == r3 - 1
                  ? a4--
                  : f5 == r3 + 1
                    ...
                    : f5 > r3
                      ? s4 > e3 - r3
                        ? (a4 += f5 - r3)
                        : a4--
                      : f5 < r3 && (f5 == r3 - a4 ? (a4 -= f5 - r3) : a4++),
                f5 !== t3 + a4 && (i6.__u |= 65536)))
          : (o4 = u5[r3]) &&
            null == o4.key &&
            o4.__e &&
            0 == (131072 & o4.__u) &&
            (o4.__e == n2.__d && (n2.__d = x(o4)), V(o4, o4, false), (u5[r3] = null), s4--);
  ...
  function A(n2, l4, u5, t3, i6) {
    var o4;
    n: if ("style" === l4)
      if ("string" == typeof u5) n2.style.cssText = u5;
      else {
      ...
      (o4 = l4 !== (l4 = l4.replace(/(PointerCapture)$|Capture$/i, "$1"))),
        (l4 = l4.toLowerCase() in n2 || "onFocusOut" === l4 || "onFocusIn" === l4 ? l4.toLowerCase().slice(2) : l4.slice(2)),
        n2.l || (n2.l = {}),
        (n2.l[l4 + o4] = u5),
        u5 ? (t3 ? (u5.u = t3.u) : ((u5.u = e), n2.addEventListener(l4, o4 ? s : c, o4))) : n2.removeEventListener(l4, o4 ? s : c, o4);
    else {
      ...
      "function" == typeof u5 ||
        (null == u5 || (false === u5 && "-" !== l4[4]) ? n2.removeAttribute(l4) : n2.setAttribute(l4, "popover" == l4 && 1 == u5 ? "" : u5));
    }
  }
  function F(n2) {
    return function (u5) {
    ...
    n: if ("function" == typeof T3)
      try {
        if (
          ...
          (C3 = (a4 = T3.contextType) && i6[a4.__c]),
          (M2 = a4 ? (C3 ? C3.props.value : a4.__) : i6),
          t3.__c
            ? (g2 = (h4 = u5.__c = t3.__c).__ = h4.__E)
            : (x3 ? (u5.__c = h4 = new T3(m3, M2)) : ((u5.__c = h4 = new b(m3, M2)), (h4.constructor = T3), (h4.render = q)),
              C3 && C3.sub(h4),
              (h4.props = m3),
              h4.state || (h4.state = {}),
              (h4.context = M2),
              ...
              (h4.__h = []),
              (h4._sb = [])),
          x3 && null == h4.__s && (h4.__s = h4.state),
          x3 &&
            null != T3.getDerivedStateFromProps &&
            (h4.__s == h4.state && (h4.__s = d({}, h4.__s)), d(h4.__s, T3.getDerivedStateFromProps(m3, h4.__s))),
          (v4 = h4.props),
          (w4 = h4.state),
          (h4.__v = u5),
          p4)
        )
          x3 && null == T3.getDerivedStateFromProps && null != h4.componentWillMount && h4.componentWillMount(),
            x3 && null != h4.componentDidMount && h4.__h.push(h4.componentDidMount);
        else {
          if (
            (x3 && null == T3.getDerivedStateFromProps && m3 !== v4 && null != h4.componentWillReceiveProps && h4.componentWillReceiveProps(m3, M2),
            !h4.__e && ((null != h4.shouldComponentUpdate && false === h4.shouldComponentUpdate(m3, h4.__s, M2)) || u5.__v === t3.__v))
          ) {
            for (
              u5.__v !== t3.__v && ((h4.props = m3), (h4.state = h4.__s), (h4.__d = false)),
                u5.__e = t3.__e,
                u5.__k = t3.__k,
                u5.__k.forEach(function (n3) {
                  n3 && (n3.__ = u5);
                }),
                P2 = 0;
              P2 < h4._sb.length;
          ...
          null != h4.componentWillUpdate && h4.componentWillUpdate(m3, h4.__s, M2),
            x3 &&
        ...
        if (((h4.context = M2), (h4.props = m3), (h4.__P = n2), (h4.__e = false), ($3 = l.__r), (I2 = 0), x3)) {
          for (h4.state = h4.__s, h4.__d = false, $3 && $3(u5), a4 = h4.render(h4.props, h4.state, h4.context), H = 0; H < h4._sb.length; H++)
        ...
        (h4.state = h4.__s),
          null != h4.getChildContext && (i6 = d(d({}, i6), h4.getChildContext())),
          x3 && !p4 && null != h4.getSnapshotBeforeUpdate && (_2 = h4.getSnapshotBeforeUpdate(v4, w4)),
          S(n2, y((L2 = null != a4 && a4.type === k && null == a4.key ? a4.props.children : a4)) ? L2 : [L2], u5, t3, i6, o4, r3, f5, e3, c4, s4),
          (h4.base = u5.__e),
          (u5.__u &= -161),
          h4.__h.length && f5.push(h4),
          g2 && (h4.__E = h4.__ = null);
      } catch (n3) {
  ...
  function z(l4, u5, t3, i6, o4, r3, f5, e3, c4) {
    ...
    if (null === b3) m3 === k3 || (e3 && l4.data === k3) || (l4.data = k3);
      ...
      if (((r3 = r3 && n.call(l4.childNodes)), (m3 = t3.props || h), !e3 && null != r3))
        for (m3 = {}, s4 = 0; s4 < l4.attributes.length; s4++) m3[(d4 = l4.attributes[s4]).name] = d4.value;
      for (s4 in m3)
      ...
      for (s4 in k3)
        (d4 = k3[s4]),
          "children" == s4
            ? (v4 = d4)
            : "dangerouslySetInnerHTML" == s4
              ? (a4 = d4)
              : "value" == s4
                ? (_2 = d4)
                : "checked" == s4
                  ? (g2 = d4)
                  : "key" === s4 || (e3 && "function" != typeof d4) || m3[s4] === d4 || A(l4, s4, d4, m3[s4], o4);
      if (a4) e3 || (p4 && (a4.__html === p4.__html || a4.__html === l4.innerHTML)) || (l4.innerHTML = a4.__html), (u5.__k = []);
        ...
        S(
          ...
          r3,
          f5,
          r3 ? r3[0] : t3.__k && x(t3, 0),
          e3,
          c4,
        ),
        null != r3)
      )
        for (s4 = r3.length; s4--; ) null != r3[s4] && w(r3[s4]);
      e3 ||
        ((s4 = "value"),
        void 0 !== _2 && (_2 !== l4[s4] || ("progress" === b3 && !_2) || ("option" === b3 && _2 !== m3[s4])) && A(l4, s4, _2, m3[s4], o4),
        (s4 = "checked"),
        void 0 !== g2 && g2 !== l4[s4] && A(l4, s4, g2, m3[s4], o4));
    }
    return l4;
  }
  function N(n2, u5, t3) {
  ...
  function B(u5, t3, i6) {
    var o4, r3, f5, e3;
    l.__ && l.__(u5, t3),
      (r3 = (o4 = "function" == typeof i6) ? null : (i6 && i6.__k) || t3.__k),
      (f5 = []),
      (e3 = []),
      O(
        t3,
        (u5 = ((!o4 && i6) || t3).__k = _(k, null, [u5])),
        r3 || h,
        h,
        t3.namespaceURI,
        !o4 && i6 ? [i6] : r3 ? null : t3.firstChild ? n.call(t3.childNodes) : null,
        f5,
        !o4 && i6 ? i6 : r3 ? r3.__e : t3.firstChild,
        o4,
        e3,
      ),
      j(f5, u5, e3);
  ...
  (n = p.slice),
    (l = {
      __e: function (n2, l4, u5, t3) {
        for (var i6, o4, r3; (l4 = l4.__); )
          if ((i6 = l4.__c) && !i6.__)
            try {
              if (
                ((o4 = i6.constructor) && null != o4.getDerivedStateFromError && (i6.setState(o4.getDerivedStateFromError(n2)), (r3 = i6.__d)),
                null != i6.componentDidCatch && (i6.componentDidCatch(n2, t3 || {}), (r3 = i6.__d)),
                r3)
              )
                return (i6.__E = i6);
            } catch (l5) {
    ...
    (b.prototype.setState = function (n2, l4) {
      var u5;
      (u5 = null != this.__s && this.__s !== this.state ? this.__s : (this.__s = d({}, this.state))),
        "function" == typeof n2 && (n2 = n2(d({}, u5), this.props)),
        n2 && d(u5, n2),
        null != n2 && this.__v && (l4 && this._sb.push(l4), M(this));
    }),
  ...
  function w2(n2) {
    ...
    for (var r3 in e3)
      if (e3.hasOwnProperty(r3) && "children" !== r3) {
        var i6 = e3[r3];
        "function" == typeof i6 && (i6 = "function " + (i6.displayName || i6.name) + "() {}"),
          (i6 = Object(i6) !== i6 || i6.toString ? i6 + "" : Object.prototype.toString.call(i6)),
          (o4 += " " + r3 + "=" + JSON.stringify(i6));
      }
    var s4 = e3.children;
...
` + f2(this.__v),
      ...
      (l.__e = function (n3, e3, t4, o4) {
        ...
        (l.__b = function (e3) {
          ...
          if ("function" == typeof e3.type && e3.type.propTypes) {
            ...
            var l5 = e3.props;
            e3.type.__f &&
              delete (l5 = (function (n3, e4) {
                for (var t4 in e4) n3[t4] = e4[t4];
                return n3;
              })({}, l5)).ref,
              (function (n3, e4, t4, r5, a4) {
                Object.keys(n3).forEach(function (t5) {
                  ...
                  i7 &&
                    !(i7.message in o2) &&
                    ((o2[i7.message] = true), console.error("Failed prop type: " + i7.message + ((a4 && "\n" + a4()) || "")));
                });
      ...
      (l.vnode = function (n3) {
        ...
        (l.diffed = function (e3) {
          ...
          if (
            ...
            var s4 = h2(i6);
            if ("" !== s4 && y2(o4))
              "table" === o4 && "td" !== s4 && y2(s4)
                ? (console.log(s4, i6.__e),
                  console.error("Improper nesting of table. Your <table> should not have a table-node parent." + w2(e3) + "\n\n" + f2(e3)))
                : ("thead" !== o4 && "tfoot" !== o4 && "tbody" !== o4) || "table" === s4
                  ? "tr" === o4 && "thead" !== s4 && "tfoot" !== s4 && "tbody" !== s4
              ...
              c5.length &&
                console.error(
                  "Improper nesting of paragraph. Your <p> should not have " + c5.join(", ") + "as child-elements." + w2(e3) + "\n\n" + f2(e3),
                );
            } else
              ("a" !== o4 && "button" !== o4) ||
                (-1 !== d2(e3).indexOf(o4) &&
  ...
  function tw(...classes) {
    return classes
      .flat(5)
      .filter(s4 => typeof s4 === "string" && !/^;|;$/.test(s4))
      .join(" ");
  }
  ...
  (c3.__b = function (n2) {
    ...
    (c3.__r = function (n2) {
      ...
      i6 &&
        (u3 === r2
          ? ((i6.__h = []),
            (r2.__h = []),
            i6.__.forEach(function (n3) {
              n3.__N && (n3.__ = n3.__N), (n3.i = n3.__N = void 0);
            }))
          : (i6.__h.forEach(z2), i6.__h.forEach(B2), (i6.__h = []), (t2 = 0))),
        (u3 = r2);
    }),
    (c3.diffed = function (n2) {
      ...
      t3 &&
        t3.__H &&
        (t3.__H.__h.length && ((1 !== f3.push(t3) && i4 === c3.requestAnimationFrame) || ((i4 = c3.requestAnimationFrame) || w3)(j2)),
  ...
  var FULLCIRCLE = /* @__PURE__ */ u4("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 18 18",
    class: css,
    children: [/* @__PURE__ */ u4("title", { children: "Circle" }), /* @__PURE__ */ u4("circle", { class: "fill", cx: "9", cy: "9", r: "8" })],
  });
  var SUN = /* @__PURE__ */ u4("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 18 18",
    class: css,
    children: [
      ...
      /* @__PURE__ */ u4("path", {
        d: "m9,5.05c2.18152,0,3.95,1.76848,3.95,3.95s-1.76848,3.95-3.95,3.95-3.95-1.76848-3.95-3.95,1.76848-3.95,3.95-3.95Zm-.9-4.8v2.5c0,.13807.11193.25.25.25h1.3c.13807,0,.25-.11193.25-.25V.25c0-.13807-.11193-.25-.25-.25h-1.3c-.13807,0-.25.11193-.25.25Zm0,15v2.5c0,.13807.11193.25.25.25h1.3c.13807,0,.25-.11193.25-.25v-2.5c0-.13807-.11193-.25-.25-.25h-1.3c-.13807,0-.25.11193-.25.25ZM0,8.35v1.3c0,.13807.11193.25.25.25h2.5c.13807,0,.25-.11193.25-.25v-1.3c0-.13807-.11193-.25-.25-.25H.25c-.13807,0-.25.11193-.25.25Zm15,0v1.3c0,.13807.11193.25.25.25h2.5c.13807,0,.25-.11193.25-.25v-1.3c0-.13807-.11193-.25-.25-.25h-2.5c-.13807,0-.25.11193-.25.25Zm-2.01021-4.23913l.91924.91924c.09763.09763.25592.09763.35355,0l1.76777-1.76777c.09763-.09763.09763-.25592,0-.35355l-.91924-.91924c-.09763-.09763-.25592-.09763-.35355,0l-1.76777,1.76777c-.09763.09763-.09763.25592,0,.35355ZM1.98978,15.11121l.91924.91924c.09763.09763.25592.09763.35355,0l1.76777-1.76777c.09763-.09763.09763-.25592,0-.35355l-.91924-.91924c-.09763-.09763-.25592-.09763-.35355,0l-1.76777,1.76777c-.09763.09763-.09763.25592,0,.35355Zm-.01031-11.8587l1.76777,1.76777c.09763.09763.25592.09763.35355,0l.91924-.91924c.09763-.09763.09763-.25592,0-.35355l-1.76777-1.76777c-.09763-.09763-.25592-.09763-.35355,0l-.91924.91924c-.09763.09763-.09763.25592,0,.35355Zm10.9902,10.99001l1.76777,1.76777c.09763.09763.25592.09763.35355,0l.91924-.91924c.09763-.09763.09763-.25592,0-.35355l-1.76777-1.76777c-.09763-.09763-.25592-.09763-.35355,0l-.91924.91924c-.09763.09763-.09763.25592,0,.35355Z",
      }),
    ],
  });
  var MOON = /* @__PURE__ */ u4("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 18 18",
    class: css,
    children: [
      ...
      /* @__PURE__ */ u4("path", {
        d: "M9,1a8,8,0,1,0,8,8A8,8,0,0,0,9,1Zm.5,14.982c-.165.0115-.332.018-.5.018A7,7,0,0,1,9,2c.168,0,.335.0065.5.018A11,11,0,0,0,9.5,15.982Z",
      }),
    ],
  });
  var MENU = /* @__PURE__ */ u4("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 18 18",
    class: css,
    children: [
  ...
  var FILTER_EDIT = /* @__PURE__ */ u4("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 18 18",
    class: css,
    children: [
  ...
  var ToggleAllAny = class _ToggleAllAny extends IconButtonBaseState {
    ...
    get icon() {
      ...
      return /* @__PURE__ */ u4("span", {
        class: tw("flex flex-row gap-1", "items-center"),
        children: [
  ...
  function VertexInfo({ vertex, open, tab }) {
    ...
    return /* @__PURE__ */ u4("div", {
      ...
      children: [
        /* @__PURE__ */ u4("h2", {
          class: tw(forGrid && "inline sm:block"),
          children: /* @__PURE__ */ u4("a", {
            class: "text-foreground decoration-1 decoration-dotted",
            href: `/${vertex?.plainKey}`,
            children: vertex?.name ?? "",
          }),
        }),
        vertex &&
          /* @__PURE__ */ u4(k, {
            children: [
              ...
              /* @__PURE__ */ u4("div", {
                class: tw(forGrid && "hidden sm:block"),
                children: [
              ...
              /* @__PURE__ */ u4("details", {
                class: tw(forGrid && "hidden sm:block", "pb-4"),
                open,
                children: [
  ...
  function updateLocalStorage(tab, key, data2) {
    localStorage.setItem(storageKey(tab, key), JSON.stringify(data2));
  }
  ...
  function FacetBool({ groupKey, facetKey, label: label2, valueMapper = checked => new ValBool(checked) }) {
    const input = A2();
  ...
  function FacetText({ groupKey, facetKey, label: label2 }) {
    const main = x2(FacetsMainContext);
  ...
  function FacetMulti({ active, facetKey, groupKey, label: label2 }) {
    const self = A2();
    const input = A2();
    const main = x2(FacetsMainContext);
    ...
    const body = () =>
      /* @__PURE__ */ u4(k, {
        children: [
          ...
          /* @__PURE__ */ u4("span", {
            class: tw(state.value.size === 0 && "hidden", state.value.size < 2 ? "text-foreground/50" : "text-foreground", "pl-2"),
            children: /* @__PURE__ */ u4(IconButton, { action: "allAny", disabled: state.value.size < 2, initial: "any" }),
          }),
          /* @__PURE__ */ u4("ul", {
            children: mapEntries(([idx, value]) =>
              /* @__PURE__ */ u4(
                "li",
                {
                  children: /* @__PURE__ */ u4("button", {
                    ...
                    children: [/* @__PURE__ */ u4("div", { class: "-mt-[2px] inline-block scale-75 text-red-500", children: CLOSE }), value],
                  }),
                },
                value,
              ),
  ...
  function Header({ action, class: cssClass2, col, config, order }) {
    return /* @__PURE__ */ u4("button", {
      ...
      children: /* @__PURE__ */ u4("div", {
        class: tw(HOVER, "inline-flex w-full", "p-1", "items-center justify-between", "gap-1"),
        children: [
  ...
  function FacetTable({ groupKey, facetKey, config, active }) {
    const self = A2();
    const main = x2(FacetsMainContext);
    ...
    const body = () =>
      /* @__PURE__ */ u4("div", {
        class: tw("grid grid-cols-[1fr_auto_auto]", "overflow-y-auto", "relative"),
        children: [
          /* @__PURE__ */ u4("div", {
            class: tw(ROW, "sticky top-0 cursor-pointer", tw(BORDER, "border-b-1")),
            children: [
              /* @__PURE__ */ u4("div", {
                class: tw("col-span-3", "py-1", "flex shrink-0 flex-row", "bg-background", CENTER_ROW, tw(BORDER, "border-t-1")),
                children: /* @__PURE__ */ u4("span", {
                  class: tw("pl-2", CENTER_ROW, state.value.size < 2 ? "text-foreground/50" : "text-foreground"),
                  children: /* @__PURE__ */ u4(IconButton, {
                    action: "allAny",
                    disabled: state.value.size < 2,
                    initial: state.value.mode,
                    class: tw(config.kind === "prop" && "hidden"),
                  }),
                }),
              }),
              /* @__PURE__ */ u4("div", {
                class: tw(ROW, "col-span-3", "bg-primary text-background/80"),
                children: [
                  /* @__PURE__ */ u4(Header, {
                    class: "text-left",
                    action: () => state.doToggleOrder("facet"),
                    col: "facet",
                    config,
                    order: state.order,
                  }),
                  /* @__PURE__ */ u4(Header, {
                    class: "text-center",
                    action: () => state.doToggleOrder("count"),
                    col: "count",
                    config,
                    order: state.order,
                  }),
                  /* @__PURE__ */ u4(Header, {
                    class: "text-right",
                    action: () => state.doToggleOrder("sel"),
                    col: "sel",
                    config,
                    order: state.order,
                  }),
            ...
            ret(
              ...
              clickOrEnter =>
                /* @__PURE__ */ u4(
                  "div",
                  {
                    class: tw(ROW, HOVER, state.value.has(entry.value) && "bg-primary/20"),
                    ...clickOrEnter,
                    children: [
                      /* @__PURE__ */ u4("div", {
                        class: tw("p-2", "text-left", "overflow-hidden text-ellipsis", "line-clamp-3"),
                        children: entry.label,
                      }),
                      /* @__PURE__ */ u4("div", { class: tw("p-2", "text-center"), children: entry.count }),
                      /* @__PURE__ */ u4("div", {
                        class: tw("p-2", "text-right"),
                        children: /* @__PURE__ */ u4("input", { type: "checkbox", checked: state.value.has(entry.value), ...clickOrEnter }),
                      }),
                    ],
                  },
                  entry.value,
  ...
  function createFacetGroupsComponent(groups) {
    return ({ currentFacetGroup }) =>
      /* @__PURE__ */ u4(k, {
        children: [...groups.entries()].map(([groupKey, { title, facets }]) =>
          /* @__PURE__ */ u4(
            FacetGroup,
            {
              groupKey,
              label: title,
              active: currentFacetGroup === groupKey,
  ...
  function FacetGroup({ label: label2, groupKey, active, children }) {
    const main = x2(FacetsMainContext);
    const hasValues = main.groupHasValues(groupKey);
    return /* @__PURE__ */ u4("div", {
      class: tw("flex-1", "flex flex-col", "overflow-hidden", !active && "hidden"),
      children: [
        /* @__PURE__ */ u4("header", {
          class: tw(
            "sticky top-0 z-10",
  ...
  var [GROUPS, GK_BY_FK, COMPONENT] = defineFacetGroups({
    ...
    general: {
      ...
      facets: [
        text("name", "App Name"),
        bool("createdRecently", "Created Recently", checked =>
          checked ? new ValNumber(/* @__PURE__ */ new Date().getFullYear() - 5) : new ValNil(),
        ),
        bool("releasedRecently", "Released Recently", checked =>
          checked ? new ValNumber(/* @__PURE__ */ new Date().getFullYear() - 1) : new ValNil(),
        ),
  ...
  function FacetsMain({ tab, pg }) {
    ...
    const body = () =>
      !state
        ? null
        : /* @__PURE__ */ u4(FacetsMainContext.Provider, {
            value: state,
            children: [
              /* @__PURE__ */ u4("div", {
                class: tw(tw(BORDER, "border-r-1"), "overflow-y-scroll", "shrink-0 grow-0"),
                children: /* @__PURE__ */ u4("div", {
                  class: tw("grid grid-cols-[auto_auto]", "gap-2", "pt-1"),
                  children: state.nav.groupKeys.flatMap(keys =>
                    // Subgrid respects the alignment of indicators while allowing to group the links and add a border.
                    /* @__PURE__ */ u4(
                      "div",
                      {
                        class: tw("col-span-2", "grid grid-cols-subgrid", "items-center", "pb-2", tw(BORDER, "border-b-1")),
                        children: keys.map(groupKey =>
                          /* @__PURE__ */ u4(
                            k,
                            {
                              children: [
                                /* @__PURE__ */ u4("div", {
                                  class: tw("mt-[.45rem] pl-1", state.groupHasValues(groupKey) ? "text-primary" : "text-foreground/20 text-xs"),
                                  children: /* @__PURE__ */ u4("div", { class: "-mt-[2px] scale-66", children: FULLCIRCLE }),
                                }),
                                /* @__PURE__ */ u4("button", {
              ...
              /* @__PURE__ */ u4("div", {
                class: tw("flex w-full flex-col", "overflow-hidden", "bg-linear-to-b to-secondary/50"),
                children: /* @__PURE__ */ u4(state.groupsComponent, { currentFacetGroup: state.currentGroupKey }),
              }),
            ],
          });
    return /* @__PURE__ */ u4("aside", {
      ref: self,
  ...
  function getPlang(pg, target) {
    const key = data(target.closest(`[${dataKey("vertex-key")}]`), "vertex-key");
    if (key) return pg.plang.get(key);
  }
  function lastPlang(pg) {
    try {
      const { key, data: data2 } = JSON.parse(localStorage.getItem("last-plang") || "{}");
      return new VPlang(pg, key).merge(data2);
    } catch (err) {
      console.warn(err);
    }
  }
  ...
  async function start() {
    ...
    const loadData = fetch("/plangs.json")
      .then(async r3 => pg.loadJSON(await r3.json()))
      .then(g2 => g2.materialize());
